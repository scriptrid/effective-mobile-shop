...
import ru.scriptrid.organizationservice.exceptions.RequestOrganizationNotFoundException;
...
import ru.scriptrid.organizationservice.repository.RequestOrganizationRepository;
...
public class RequestService {
    ...
    public List<RequestOrganizationDto> getRequests() {
        ...
        if (requests.isEmpty()) {
            throw new NoSuchRequestsException();
        }
    ...
    public RequestOrganizationDto getRequest(long id) {
        RequestOrganizationEntity request = requestOrganizationRepository.findById(id)
                .orElseThrow(RequestOrganizationNotFoundException::new);
    ...
    public void declineRequest(long id) {
        if (!requestOrganizationRepository.existsById(id)) {
            throw new RequestOrganizationNotFoundException();
        }
