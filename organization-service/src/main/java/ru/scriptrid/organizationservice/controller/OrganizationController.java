...
import ru.scriptrid.organizationservice.service.OrganizationService;
...
public class OrganizationController {
    ...
    public ResponseEntity<OrganizationDto> editOrganization(@AuthenticationPrincipal JwtAuthenticationToken token,
        ...
        OrganizationDto organizationDto = organizationService.editOrganization(token, id, dto, logo);
        return ResponseEntity.ok(organizationDto);
    }
